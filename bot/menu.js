...
const MENU_CATEGORIES = [
  {
    ...
    items: [
      {
        cmd: "anime",
        desc: "Search anime information & score",
        status: "live",
      },
      ...
      {
        cmd: "pinterest",
        desc: "Search Pinterest for aesthetic images",
        status: "live",
      },
      ...
      {
        cmd: "ongoing",
        desc: "Currently airing anime this season",
        status: "live",
      },
    ],
  },
  {
    ...
    items: [
      {
        cmd: "gtguide",
        desc: "Genshin team composition guide",
        status: "basic",
      },
      {
        cmd: "hsrguide",
        desc: "Honkai: Star Rail build guide",
        status: "basic",
      },
      {
        cmd: "wuwaguide",
        desc: "Wuthering Waves starter guide",
        status: "basic",
      },
      {
        cmd: "genshinguide",
        desc: "Genshin Impact general guide",
        status: "basic",
      },
      {
        cmd: "endfieldguide",
        desc: "Arknights: Endfield guide",
        status: "basic",
      },
      ...
      {
        cmd: "nteguide",
        desc: "NIKKE team composition guide",
        status: "basic",
      },
      {
        cmd: "genshinakun",
        desc: "Genshin account estimation",
        status: "basic",
      },
      {
        cmd: "usernameml",
        desc: "Mobile Legends nickname generator",
        status: "live",
      },
      {
        cmd: "usernameff",
        desc: "Free Fire nickname generator",
        status: "live",
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        cmd: "infogempa",
        desc: "Latest earthquake data (BMKG)",
        status: "live",
      },
      {
        cmd: "infokurs",
        desc: "Real-time foreign exchange rate",
        status: "live",
      },
      {
        cmd: "crypto",
        desc: "Real-time cryptocurrency prices",
        status: "live",
      },
  ...
  },
  {
    ...
    items: [
      ...
      {
        cmd: "toimage",
        desc: "Convert WA sticker back to image",
        status: "live",
      },
      {
        cmd: "stickermeme",
        desc: "Create custom meme sticker",
        status: "live",
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        cmd: "nulis",
        desc: "Minimalist brat/aesthetic text card",
        status: "live",
      },
      ...
      {
        cmd: "googlevoice",
        desc: "Google voice audio generator",
        status: "live",
      },
      {
        cmd: "texttospeak",
        desc: "Multi-language voice generator",
        status: "live",
      },
  ...
  },
  {
    ...
    items: [
      ...
      {
        cmd: "botinfo",
        desc: "Bot engine version & system stats",
        status: "live",
      },
